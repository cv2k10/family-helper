...
const ShowOrderForm = () => {  
  ...
  const initGoogleMapsPlaces = () => {
    ...
    var klangValleyBounds = new google.maps.LatLngBounds(
      ...
      new google.maps.LatLng(3.3705, 101.794044)
    );
    ...
    autocomplete1.setComponentRestrictions({ country: "my" });

    autocomplete2.setComponentRestrictions({ country: "my" });
  };
        ...
        >
          ...
          <span style={{ flex: 1 }}>
            <input
              ...
              defaultChecked={true}
              onChange={() =>
                (inputHealthStatus.current.className = "disp-none")
              }
            />
          ...
          <select
            ...
            onChange={(e) =>
              setQueryInput({ ...queryInput, time: e.target.value })
            }
            className="dropdown"
          >
          ...
          <select
            ...
            onChange={(e) =>
              setQueryInput({ ...queryInput, area: e.target.value })
            }
            className="dropdown"
          >
